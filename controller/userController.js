...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    linkedInURL,
    avatar: {
      public_id: cloudinaryResponseForAvatar.public_id, // Using the correct avatar response
      url: cloudinaryResponseForAvatar.secure_url, // Using the correct avatar response
    },
    resume: {
      public_id: cloudinaryResponseForResume.public_id, // Using the correct resume response
      url: cloudinaryResponseForResume.secure_url, // Using the correct resume response
    },
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "66f58611d8ef0ac75177fb71";
